...
import org.deeplearning4j.arbiter.conf.Configuration;
import org.deeplearning4j.arbiter.conf.Distribution;
import org.deeplearning4j.arbiter.conf.distribution.Distributions;
import org.deeplearning4j.arbiter.conf.schedule.FixedSchedule;
import org.deeplearning4j.arbiter.conf.saving.JsonModelSerializer;
import org.deeplearning4j.arbiter.conf.updater.AdamIUpdater;
import org.deeplearning4j.arbiter.scoring.RegressionScoreFunction;
import org.deeplearning4j.arbiter.scoring.impl.RegressionScoreFunction.Metric;
...
public class HousePricePrediction {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                .updater(new Adam(0.01))  // Adjust learning rate for hyperparameter tuning
                .list()
        ...
        // Set up UI server for monitoring
        ...
        // Evaluate the model
        RegressionEvaluation evaluation = model.evaluateRegression(testIterator);
        ...
        // Save the model
        File locationToSave = new File("HousePricePredictionModel.zip");
